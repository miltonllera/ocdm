...
def main(args):
    ...
    SpriteGenerator(
        ...
        0,
        args.aa,
        canonical_interpolation=Image.LANCZOS  # type: ignore
    )(SpriteLoader(), args.folder)
...
class SpriteLoader(SpriteDict):
    ...
    def __getitem__(self, entry: Union[int, str]):
        if isinstance(entry, str):
            entry = SpriteLoader.Names[entry]  # type: ignore
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_angles", type=int, default=40,
    ...
    parser.add_argument("--lim_ys", type=float, default=None, nargs=2,
        help="Hue range in HSV format")
    parser.add_argument("--num_ys", type=int, default=20,
