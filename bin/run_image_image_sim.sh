...
# uv run python -m scripts.image_image_sim \
#   --dataset_name dsprites \
#   --filter_expr "${FILTER_EXPR}" \
#   --model_name vae \
#   --model_checkpoint "${RESULTS_FLDR}/${CKPT}" \
#   --query_factor orientation
...
# CKPT=figure1/combgen_dsprites_heart_rotation_sa_on:2026-03-13_13-21/epoch=517-step=497280.ckpt
# uv run python -m scripts.image_image_sim \
#   --dataset_name dsprites \
#   --filter_expr "${FILTER_EXPR}" \
#   --model_name sa1 \
