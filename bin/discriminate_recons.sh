...
CLASSIFIER_PATH="${RESULTS_FLDR}/discriminators/dsprites_vae_shape_position/epoch=1-step=16128.ckpt"
...
uv run python -m scripts.classify_recons \
  --dataset_name dsprites \
  --filter_expr "${FILTER_EXPR}" \
  --model_name vae \
  --model_checkpoint "${RESULTS_FLDR}/${CKPT}" \
  --classifier_type discriminator \
...
CLASSIFIER_PATH="${RESULTS_FLDR}/discriminators/dsprites_vae_shape_rotation/epoch=505-step=485760.ckpt"
...
CLASSIFIER_PATH="${RESULTS_FLDR}/discriminators/shapes3d_vae_shape_hue/epoch=5-step=31500.ckpt"
...
CLASSIFIER_PATH="${RESULTS_FLDR}/discriminators/pentominos_vae_shape_rotation/epoch=2-step=31500.ckpt"
