...
# CLASSIFIER_PATH="${RESULTS_FLDR}/classifiers/dsprites_shape_classifier/epoch=3-step=32256.ckpt"
...
#   --classifier_type factor_prediction \
...
# CLASSIFIER_PATH="${RESULTS_FLDR}/classifiers/shapes3d_shape_classifier/epoch=8-step=47250.ckpt"
...
# CLASSIFIER_PATH="${RESULTS_FLDR}/classifiers/pentomino_shape_classifier/epoch=2-step=31500.ckpt"
